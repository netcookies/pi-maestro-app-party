...
- 更新功能亮点（多题交互向导、系统推送与灵动岛通知、生命周期感知）
- 升级 README 界面展示画廊与全量最新高清真机截图
- 添加 v0.3.2 官方发版海报、功能演示切片与动态交互页面

### 新增

- 实现多题步进向导、系统通知与灵动岛横幅通知、全生命周期工作态感知

### 修复

- 修复问答外部应答文件监听隔离、事件流倒序终结状态判定与真实版本探测
...
- 修复 release 工作流中的重复 release 覆盖容错与双 tag 发布触发
- resolve app startup crash and compile assets without icon border
